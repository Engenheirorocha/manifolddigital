...
window.errorCategories = [
  {name:"Split",search:["split","evaporadora"],icon:svgSplit()},
  {name:"Cassete",search:["cassete","casete","teto"],icon:svgCassete()},
  {name:"Janela",search:["janela","ar janela","ar de janela"],icon:svgJanela()},
  {name:"Piso Teto",search:["piso teto","piso-teto","piso","teto"],icon:svgPisoTeto()}
];
